...
DT <- fread("../data-raw/31-bbx_data_az_ca_nv_border_regions_zip3.csv") %>%
...
mod <- felm(HAS_BEEN_REO_FORC_CUMSUM ~ CA * ACTIVITYDT |
...
saveRDS(p.bbx.ca.border, "RdsFiles/20-p_bbx_diff_diff_az_ca_nv.rds")
